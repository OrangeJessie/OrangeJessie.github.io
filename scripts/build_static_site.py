...
def render_view_counter(class_name: str = "view-counter") -> str:
    return f"""
    <span class="{class_name}" title="浏览次数">
      ...
      <span class="view-counter__value" id="busuanzi_container_page_pv">
...
def inject_standalone_blog_bridge(document_html: str, post: Post) -> str:
  ...
  <style id="oj-blog-bridge-style">
    ...
    .oj-blog-bridge a:hover,
    .oj-blog-bridge button:hover {{
      background: #eef2f7;
      color: #0f172a;
      text-decoration: none;
    }}
    .oj-blog-bridge .oj-blog-bridge__primary {{
      background: #111827;
      color: #ffffff;
    }}
    .oj-blog-bridge .oj-blog-bridge__primary:hover {{
      background: #020617;
      color: #ffffff;
    }}
    .oj-blog-bridge .oj-blog-bridge__views {{
      ...
      background: #f8fafc;
      color: #334155;
      font: 700 14px/1 -apple-system, BlinkMacSystemFont, "Segoe UI", "Noto Sans SC", "PingFang SC", Arial, sans-serif;
      white-space: nowrap;
    }}
    ...
    .oj-blog-bridge .oj-blog-bridge__views .view-counter__value {{
      line-height: 1;
    }}
...
"""
    ...
    return document_html + bridge_html
