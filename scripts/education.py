...
def render_history() -> str:
    ...
    <details class="education-history">
      ...
      <div class="education-history__gallery">
        ...
        <figure><a href="/assets/img/education/consultation-feedback-2.png" target="_blank" rel="noopener"><img src="/assets/img/education/consultation-feedback-2.png" alt="求职准备与面试交流反馈" width="764" height="408" loading="lazy"></a><figcaption>求职准备与面试交流反馈</figcaption></figure>
        <figure><a href="/assets/img/education/consultation-feedback-3.png" target="_blank" rel="noopener"><img src="/assets/img/education/consultation-feedback-3.png" alt="面试表达与 AI 项目交流反馈" width="740" height="324" loading="lazy"></a><figcaption>面试表达与 AI 项目交流反馈</figcaption></figure>
      </div>
    </details>
    """
